...
namespace Dominio
{
    public class Sistema
    {
        ...
        // aca tenemos que armar la precarga
        ...
        // metodos para crear/dar alta
        public void AltaPartido()
        {

        }

        public void AltaPeriodista()
        {

        }


        public void NuevaIncidencia(bool finalizado)
        {

        }

        public void SubirResenia()
        {
